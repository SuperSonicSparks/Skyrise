...
#pragma config(Motor,  port3,           leftSideLift,  tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port6,           frontRight,    tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
#pragma config(Motor,  port7,           backRight,     tmotorVex393_MC29, openLoop, reversed, encoderPort, I2C_3)
#pragma config(Motor,  port8,           rightSideLift, tmotorVex393_MC29, openLoop)
